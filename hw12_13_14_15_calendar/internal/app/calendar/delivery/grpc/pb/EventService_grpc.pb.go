...
type CalendarClient interface {
	GetList(ctx context.Context, in *GetListQuery, opts ...grpc.CallOption) (*GetListResponse, error)
	GetEvent(ctx context.Context, in *GetEventQuery, opts ...grpc.CallOption) (*GetEventResponse, error)
	CreateEvent(ctx context.Context, in *CreateEventCommand, opts ...grpc.CallOption) (*CreateEventResponse, error)
	UpdateEvent(ctx context.Context, in *UpdateEventCommand, opts ...grpc.CallOption) (*UpdateEventResponse, error)
}
...
func (c *calendarClient) GetList(ctx context.Context, in *GetListQuery, opts ...grpc.CallOption) (*GetListResponse, error) {
	out := new(GetListResponse)
	err := c.cc.Invoke(ctx, "/event.Calendar/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calendarClient) GetEvent(ctx context.Context, in *GetEventQuery, opts ...grpc.CallOption) (*GetEventResponse, error) {
...
func (c *calendarClient) CreateEvent(ctx context.Context, in *CreateEventCommand, opts ...grpc.CallOption) (*CreateEventResponse, error) {
...
func (c *calendarClient) UpdateEvent(ctx context.Context, in *UpdateEventCommand, opts ...grpc.CallOption) (*UpdateEventResponse, error) {
...
type CalendarServer interface {
	GetList(context.Context, *GetListQuery) (*GetListResponse, error)
	GetEvent(context.Context, *GetEventQuery) (*GetEventResponse, error)
	CreateEvent(context.Context, *CreateEventCommand) (*CreateEventResponse, error)
	UpdateEvent(context.Context, *UpdateEventCommand) (*UpdateEventResponse, error)
...
func (UnimplementedCalendarServer) GetList(context.Context, *GetListQuery) (*GetListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetList not implemented")
}
func (UnimplementedCalendarServer) GetEvent(context.Context, *GetEventQuery) (*GetEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEvent not implemented")
}
func (UnimplementedCalendarServer) CreateEvent(context.Context, *CreateEventCommand) (*CreateEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateEvent not implemented")
}
func (UnimplementedCalendarServer) UpdateEvent(context.Context, *UpdateEventCommand) (*UpdateEventResponse, error) {
...
func _Calendar_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Calendar/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).GetList(ctx, req.(*GetListQuery))
	}
...
func _Calendar_GetEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).GetEvent(ctx, req.(*GetEventQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calendar_CreateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).CreateEvent(ctx, req.(*CreateEventCommand))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calendar_UpdateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).UpdateEvent(ctx, req.(*UpdateEventCommand))
	}
	return interceptor(ctx, in, info, handler)
}
